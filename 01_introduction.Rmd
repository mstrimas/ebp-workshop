...
To follow along with the lessons in this workshop [download the workshop data package](https://github.com/mstrimas/ebp-workshop/raw/master/raw-data/ebp-workshop.zip). This package contains a variety of datasets for Parts I and II of this workshop. Instructions for how to use each dataset will be given in the relevant lesson.
