...
From these results, it's clear that including these forest habitat covariates (especially deciduous broadleaf forest) leads to a marked improvement in model performance, as shown by the AIC and AIC weights. Let's look at the coefficients from the global model for these covariates to see how they're impacting detection and occupancy. 
