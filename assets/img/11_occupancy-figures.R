...
ggsave("assets/img/11_occupancy_grid.svg", g_grid, width = 7, height = 7)
...
g_s1 <- ggplot(grid) +
  ...
  theme(legend.text = element_text(size = 18),
        legend.title = element_text(size = 22),
        legend.position = "bottom")
ggsave("assets/img/11_occupancy_1survey.svg", g_s1, width = 7, height = 7)
...
g_s3 <- ggplot(grid) +
  ...
  theme(strip.text = element_text(size = 22),
        ...
        legend.title = element_text(size = 22),
        legend.position = "bottom")
ggsave("assets/img/11_occupancy_3surveys.svg", g_s3, width = 18, height = 6)
