...
The [workshop data package](https://github.com/mstrimas/ebp-workshop/raw/master/raw-data/ebp-workshop.zip) discussed in the [Introduction](#intro) contains all the prepared data. If you haven't already done so, download and unzip this file, then move all the files in the `data/` subdirectory to the `data/` subdirectory of your RStudio project.
