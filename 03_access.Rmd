...
The EBD is huge, so **don't download these files now**. Instead, we'll be working with a small subset of the data today, which can is available in the [workshop data package](https://github.com/mstrimas/ebp-workshop/raw/master/raw-data/ebp-workshop.zip) discussed in the [Introduction](#intro). This subset contains data from Yucatan Peninsula (Guatemala, Belize, and five Mexican sates) from 2014-2015.
