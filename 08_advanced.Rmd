...
The `auk` function `format_unmarked_occu()` takes care of the reformatting for you. In this function, `site_covs` are the site-level covariates and `obs_covs` are the observation-level covariates.
